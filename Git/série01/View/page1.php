        ...
        <section class="col-lg-10">
            <div class="row">
                ...
                <article class="col-sm-4">
                    <img class="img-responsive" src="images/2.jpg" alt="image cop23">
                    <p>COP23:"La Belgique partage le sentiment d'urgence et agit</p>
                </article>
                <article class="col-sm-4">
                    <img class="img-responsive" src="images/3.jpg" alt="hugo Clément">
                    <p>Le journaliste Hugo Clément quitte «Quoditien»</p>
                </article>

                <article class="col-sm-4">
                    <img class="img-responsive" src="images/4.jpg" alt="image sanglier coincé">
